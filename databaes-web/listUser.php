...
<br>username:<input type="text" name="username" id="username" value = "<?php print $tuple['username'] ?>"/> 
<input type="hidden" name="passwd" id="passwd" value = "<?php print $tuple['passwd'] ?>"/> 
<input type="hidden" name="historyScan" id="historyScan" value = "<?php print $tuple['historyScan'] ?>"/> 
<br>address: <input type="text" name="address" id="address" value = "<?php print $tuple['address'] ?>"/> 
<br>telephone: <input type="text" name="telephone" id="telephone" value = "<?php print $tuple['telephone'] ?>"/>
